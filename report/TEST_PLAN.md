...
| **Components Involved** | /register page ,  POST /api/auth/register ,  User model ,  emailService |
...
| **Components Involved** | /register page ,  POST /api/auth/register ,  User model |
...
| **Components Involved** | /register page ,  Zod schema ,  registerValidation middleware |
...
| **Components Involved** | /login page ,  POST /api/auth/login ,  authController |
...
| **Components Involved** | /login page ,  POST /api/auth/login ,  User.incLoginAttempts |
...
| **Components Involved** | /verify-email page ,  POST /api/auth/verify-email ,  emailService |
...
| **Components Involved** | /forgot-password ,  /reset-password ,  POST /api/auth/forgot-password ,  POST /api/auth/reset-password |
...
| **Components Involved** | Dashboard auth guard ,  protect middleware ,  GET /api/users/dashboard |
...
| **Components Involved** | protect middleware ,  authorize('admin') ,  GET /api/admin/users |
...
| **Components Involved** | authLimiter ,  POST /api/auth/login |
...
| **Components Involved** | /predictions/mental-wellness ,  POST /api/predictions/mental-wellness ,  AI: POST /predict/mental-wellness |
...
| **Components Involved** | /predictions/mental-wellness ,  GET /api/predictions/examples/mental_wellness ,  AI: GET /examples/mental-wellness |
...
| **Components Involved** | /predictions/mental-wellness ,  frontend cross-field validation |
...
| **Components Involved** | mentalWellnessValidation middleware ,  POST /api/predictions/mental-wellness |
...
| **Components Involved** | POST /api/predictions/:id/email ,  emailService ,  pdfGenerator ,  emailLimiter |
...
| **Components Involved** | GET /api/predictions/:id/pdf ,  pdfGenerator |
...
| **Components Involved** | /predictions/mental-wellness ,  recommendations modal |
...
| **Components Involved** | /predictions ,  GET /api/predictions ,  Prediction model |
...
| **Components Involved** | /predictions/stress ,  POST /api/predictions/stress-level ,  AI: POST /predict/stress |
...
| **Components Involved** | /predictions/stress ,  result rendering |
...
| **Components Involved** | stressLevelValidation middleware ,  POST /api/predictions/stress-level |
...
| **Components Involved** | AI: /predict/stress ,  /predictions/stress label rendering |
...
| **Components Involved** | predictionLimiter ,  POST /api/predictions/stress-level |
...
| **Components Involved** | AI: POST /predict/stress ,  /predictions/stress recommendations |
...
| **Components Involved** | /predictions/academic ,  POST /api/predictions/academic-impact ,  AI: POST /predict/academic-impact |
