          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="occupation" placeholder="e.g. Student" value={form.occupation} onChange={e => setForm(f => ({ ...f, occupation: e.target.value }))} />
              </div>
              <div className="space-y-1.5">
                <Label htmlFor="country">Country</Label>
                <Input id="country" placeholder="e.g. Sri Lanka" value={form.country} onChange={e => setForm(f => ({ ...f, country: e.target.value }))} />
              </div>
